...
(function (ImageCreator_1) {
    ...
    var ImageCreator = (function () {
        ...
        ImageCreator.prototype.getImageElement = function () {
            var img = $("<img/>");
            var datastring = "data:" + this.getMimeType() + ";base64," + this.resultBase64;
            img.attr("src", datastring);
            return img.get(0);
        };
        ImageCreator.prototype.uploadToImgur = function (title, description, onDone) {
        ...
        ImageCreator.prototype.updateImgurDescription = function (description) {
            var self = this;
            $.ajax({
    ...
    ImageCreator_1.PngCreator = PngCreator;
    ...
    ImageCreator_1.GIFCreator = GIFCreator;
